package FeatureExtractionUtils;

import FeatureExtractionUtils.domain.HiddenNeuron;
import FeatureExtractionUtils.domain.Neuron;
import FeatureExtractionUtils.domain.WordNeuron;
import FeatureExtractionUtils.util.Haffman;
import FeatureExtractionUtils.util.MapCount;
...
public class Learn {
  ...
  private Boolean isCbow = true;//TODO 这里原本是false
